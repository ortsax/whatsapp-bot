...
// GetAnticallRows reads all rows from anticall_settings and returns them as a map.
...
// SaveAnticallRows upserts a set of key/value pairs into anticall_settings.
